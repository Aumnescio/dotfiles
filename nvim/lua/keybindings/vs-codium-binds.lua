...
-- Key:         Ctrl-w + t
-- Action:      Move to above split.
-- bindkey("n",    "<C-w>t",    "<C-w>k",    opts)

-- Key:         Ctrl-w + h
-- Action:      Move to below split.
-- bindkey("n",    "<C-w>h",    "<C-w>j",    opts)

-- Key:         Ctrl-w + q
-- Action:      Move to left split.
-- bindkey("n",    "<C-w>q",    "<C-w>h",    opts)

-- Key:         Ctrl-w + e
-- Action:      Move to right split.
...
require("legendary").setup({
    ...
    keymaps = {
        ...
        { "t",          "k",           description = "Move cursor one line upwards.",          mode = { "n", "x", "o" },   opts = opts },
        -- Key:         h               ( Normal, Visual, Operator )
        { "h",          "j",           description = "Move cursor one line downwards.",        mode = { "n", "x", "o" },   opts = opts },
        -- Key:         Shift-t         ( Normal, Visual, Operator )
        { "<S-t>",      "5k",          description = "Move cursor 5 lines upwards.",           mode = { "n", "x", "o" },   opts = opts },
        -- Key:         Shift-h         ( Normal, Visual, Operator )
        { "<S-h>",      "5j",          description = "Move cursor 5 lines downwards.",         mode = { "n", "x", "o" },   opts = opts },
        -- Key:         Ctrl-t
