---===========-=====-==-=========-===-=========---
-- AumneChroma Theme by Aumnescio for AwesomeWM --
---===========-=====-==-=========-===-=========---

-- TODO:
--  - Set icons for things.
--      - Layout Icons (At least spiral.)
...
theme.wallpaper = "~/Pictures/Wallpapers/meditatingsworddude.jpg"
